...
public class FilmValidationTests {
    ...
    public void shouldNotValidateIfNameIsNull() {
        Film nullFilm = new Film(0, "", "description", LocalDate.of(2019, 8, 12), 120, Collections.singleton(0));
        assertThrows(ValidationException.class, () -> {
            filmController.addFilm(nullFilm);
        });
        Film noFilm = new Film(1, "", "description", LocalDate.of(2019, 8, 12), 120, Collections.singleton(0));
        assertThrows(ValidationException.class, () -> {
            filmController.addFilm(noFilm);
        });
        Film gapFilm = new Film(2, "", "description", LocalDate.of(2019, 8, 12), 120, Collections.singleton(0));
        assertThrows(ValidationException.class, () -> {
    ...
    public void shouldNotValidateIfLongDescription() {
        Film film = new Film(1, "Вавилон",
                "В 1920-х годах немое кино продолжает пользоваться популярностью, но постепенно на первый план выходят новые картины со звуком, "
                        ...
                        + "Мэнни и джазовый музыкант Сидни пробивают собственный путь к славе…", LocalDate.of(1922, 7, 21), 120, Collections.singleton(120));
    ...
    public void shouldNotValidateOldReleaseDate() {
        Film film = new Film(1, "name", "description",
                LocalDate.of(1895, 3, 22), 1, Collections.singleton(120));
        ValidationException thrown = assertThrows(ValidationException.class, () -> {
            filmController.addFilm(film);
        });
        ...
        Film film2 = new Film(0, "Пограничный фильм", "description",
                LocalDate.of(1895, 12, 28), 1, Collections.singleton(0));
        assertDoesNotThrow(() -> {
    ...
    public void shouldNotValidateIfDurationIsNegative() {
        Film film = new Film(0, "Minus 1", "Movie back in time",
                LocalDate.of(2000, 1, 1), -1, Collections.singleton(120));
        ValidationException thrown = assertThrows(ValidationException.class, () -> {
            filmController.addFilm(film);
        });
        ...
        Film film2 = new Film(1, "Фильм с нулевой длительностью", "но не в секундах",
                LocalDate.of(2000, 1, 1), 0, Collections.singleton(0));
        assertDoesNotThrow(() -> {
            filmController.addFilm(film2);
        });
    }
